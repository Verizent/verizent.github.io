      ...
      {isIntro && (
        <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce">
          <button
            ...
            className="backdrop-blur-lg bg-white/20 hover:bg-white/30 dark:bg-gray-900/20 dark:hover:bg-gray-900/30 border border-gray-300 dark:border-gray-700 shadow-lg rounded-full px-6 py-3 flex flex-col items-center gap-2 transition-all duration-300 group"
            style={{
